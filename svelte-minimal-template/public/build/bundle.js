...
var app = (function () {
    ...
    // (35:8) <Button type="reset" style="border-radius:10px;margin-bottom:1em;margin-right:1em;box-sizing: border-box;" backgroundColor="white"  width="calc(50% - 0.5em);" on:click={()=>{ loginWith('google') }}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:8) <Button type=\\\"reset\\\" style=\\\"border-radius:10px;margin-bottom:1em;margin-right:1em;box-sizing: border-box;\\\" backgroundColor=\\\"white\\\"  width=\\\"calc(50% - 0.5em);\\\" on:click={()=>{ loginWith('google') }}>",
    		ctx
    	});
    ...
    // (36:8) <Button type="reset" style="border-radius:10px;margin-bottom:1em;box-sizing: border-box;" backgroundColor="black"  width="calc(50% - 0.5em);"  on:click={()=>{ loginWith('github') }}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:8) <Button type=\\\"reset\\\" style=\\\"border-radius:10px;margin-bottom:1em;box-sizing: border-box;\\\" backgroundColor=\\\"black\\\"  width=\\\"calc(50% - 0.5em);\\\"  on:click={()=>{ loginWith('github') }}>",
    		ctx
    	});
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		if (lib.parse($querystring).token) {
    			...
    			const sessionUser = await client.auth.self(lib.parse($querystring).token);
    ...
    /* src/app/pages/logout/logout.page.svelte generated by Svelte v3.32.1 */

    function create_fragment$d(ctx) {
    	let auth;
    	let current;
    	auth = new Auth$1({ $$inline: true });
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Logout_page", slots, []);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Logout_page> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ onMount, Auth: Auth$1 });
    	return [];
    }

    class Logout_page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, data, modal, selectedUser*/ 536870925) {
    ...
    // (110:28) <Button width="8em" outline on:click={()=>{ modal.update = true; selectedUser = row }}>
    function create_default_slot_11(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(110:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.update = true; selectedUser = row }}>",
    		ctx
    	});
    ...
    // (111:28) <Button width="8em" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedUser = row }} }}>
    function create_default_slot_10(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(111:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedUser = row }} }}>",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*row*/ ctx[26].email + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*row*/ ctx[26].oAuthId + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*row*/ ctx[26].oAuthData + "";
    	let t4;
    	let t5;
    	let td3;
    	let button0;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file$b, 103, 12, 2605);
    			attr_dev(td1, "class", "oAuthId");
    			add_location(td1, file$b, 105, 12, 2664);
    			attr_dev(td2, "class", "oAuthData");
    			add_location(td2, file$b, 107, 12, 2727);
    			attr_dev(td3, "width", "8em");
    			add_location(td3, file$b, 109, 12, 2794);
    			attr_dev(td4, "width", "8em");
    			add_location(td4, file$b, 110, 12, 2931);
    			add_location(tr, file$b, 102, 8, 2587);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*data*/ 1) && t0_value !== (t0_value = /*row*/ ctx[26].email + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*data*/ 1) && t2_value !== (t2_value = /*row*/ ctx[26].oAuthId + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*data*/ 1) && t4_value !== (t4_value = /*row*/ ctx[26].oAuthData + "")) set_data_dev(t4, t4_value);
    			const button0_changes = {};
    ...
    function create_default_slot_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th1 = element("th");
    			th1.textContent = "OAuthId";
    			t5 = space();
    			th2 = element("th");
    			th2.textContent = "OAuthData";
    			t7 = space();
    			th3 = element("th");
    			...
    			add_location(div, file$b, 85, 0, 1880);
    			attr_dev(th0, "class", "sort");
    			attr_dev(th0, "data-sort", "email");
    			add_location(th0, file$b, 92, 12, 2259);
    			attr_dev(th1, "class", "sort");
    			attr_dev(th1, "data-sort", "oAuthId");
    			add_location(th1, file$b, 93, 12, 2318);
    			attr_dev(th2, "class", "sort");
    			attr_dev(th2, "data-sort", "oAuthData");
    			add_location(th2, file$b, 94, 12, 2381);
    			add_location(th3, file$b, 95, 12, 2448);
    			add_location(th4, file$b, 96, 12, 2477);
    			add_location(tr, file$b, 91, 8, 2241);
    			add_location(thead, file$b, 90, 4, 2224);
    			attr_dev(tbody, "class", "list");
    			add_location(tbody, file$b, 99, 4, 2527);
    			add_location(table, file$b, 89, 0, 2210);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_6(ctx) {
    	...
    	if (/*newUser*/ ctx[1].email !== void 0) {
    		input0_props.value = /*newUser*/ ctx[1].email;
    	}
    	...
    	if (/*newUser*/ ctx[1].oAuthId !== void 0) {
    		input1_props.value = /*newUser*/ ctx[1].oAuthId;
    	}
    	...
    	let input2_props = {
    		placeholder: "OAuthData",
    		backgroundColor: "var(--theme-light-gray)",
    		foregroundColor: "var(--theme-dark-gray)",
    		style: "margin-right:2em;"
    	};

    	if (/*newUser*/ ctx[1].oAuthData !== void 0) {
    		input2_props.value = /*newUser*/ ctx[1].oAuthData;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*newUser*/ 2) {
    				updating_value = true;
    				input0_changes.value = /*newUser*/ ctx[1].email;
    			...
    			if (!updating_value_1 && dirty & /*newUser*/ 2) {
    				updating_value_1 = true;
    				input1_changes.value = /*newUser*/ ctx[1].oAuthId;
    			...
    			if (!updating_value_2 && dirty & /*newUser*/ 2) {
    				updating_value_2 = true;
    				input2_changes.value = /*newUser*/ ctx[1].oAuthData;
    ...
    function create_default_slot_3(ctx) {
    	...
    	if (/*selectedUser*/ ctx[2].email !== void 0) {
    		input0_props.value = /*selectedUser*/ ctx[2].email;
    	}
    	...
    	if (/*selectedUser*/ ctx[2].oAuthId !== void 0) {
    		input1_props.value = /*selectedUser*/ ctx[2].oAuthId;
    	}
    	...
    	if (/*selectedUser*/ ctx[2].oAuthData !== void 0) {
    		input2_props.value = /*selectedUser*/ ctx[2].oAuthData;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$b, 130, 4, 4323);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$b, 134, 4, 4889);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*selectedUser*/ 4) {
    				updating_value = true;
    				input0_changes.value = /*selectedUser*/ ctx[2].email;
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*selectedUser*/ 4) {
    				updating_value_1 = true;
    				input1_changes.value = /*selectedUser*/ ctx[2].oAuthId;
    				add_flush_callback(() => updating_value_1 = false);
    			}
    			...
    			if (!updating_value_2 && dirty & /*selectedUser*/ 4) {
    				updating_value_2 = true;
    				input2_changes.value = /*selectedUser*/ ctx[2].oAuthData;
    				add_flush_callback(() => updating_value_2 = false);
    			}
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$b, 141, 4, 5359);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$b, 142, 4, 5385);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, modal, newUser*/ 536870922) {
    			...
    			if (dirty & /*$$scope, modal, selectedUser*/ 536870924) {
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	const settings = {
    		valueNames: ["email", "oAuthId", "oAuthData"]
    	};
    	...
    	function input1_value_binding(value) {
    		newUser.oAuthId = value;
    		$$invalidate(1, newUser);
    	}

    	function input2_value_binding(value) {
    		newUser.oAuthData = value;
    		$$invalidate(1, newUser);
    	}
    	...
    	function input1_value_binding_1(value) {
    		selectedUser.oAuthId = value;
    		$$invalidate(2, selectedUser);
    	}

    	function input2_value_binding_1(value) {
    		selectedUser.oAuthData = value;
    		$$invalidate(2, selectedUser);
    	}
    ...
    // (89:4) <Button backgroundColor="var(--theme-secondary)" width="12em" outline on:click={()=>{ modal.create = true;  }}>
    function create_default_slot_12$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(89:4) <Button backgroundColor=\\\"var(--theme-secondary)\\\" width=\\\"12em\\\" outline on:click={()=>{ modal.create = true;  }}>",
    		ctx
    	});
    ...
    // (111:28) <Button width="8em" outline on:click={()=>{ modal.update = true; selectedApp = row }}>
    function create_default_slot_11$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(111:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.update = true; selectedApp = row }}>",
    		ctx
    	});
    ...
    // (112:28) <Button width="8em" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedApp = row }} }}>
    function create_default_slot_10$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(112:28) <Button width=\\\"8em\\\" outline on:click={()=>{ modal.delete = true;  modal.target = i; selectedApp = row }} }}>",
    		ctx
    	});
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file$d, 104, 12, 2646);
    			attr_dev(td1, "class", "isPublished");
    			add_location(td1, file$d, 106, 12, 2703);
    			attr_dev(td2, "class", "detail");
    			add_location(td2, file$d, 108, 12, 2774);
    			attr_dev(td3, "width", "8em");
    			add_location(td3, file$d, 110, 12, 2835);
    			attr_dev(td4, "width", "8em");
    			add_location(td4, file$d, 111, 12, 2971);
    			add_location(tr, file$d, 103, 8, 2628);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(103:4) {#each data as row, i}",
    		ctx
    	});
    ...
    function create_default_slot_9$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "controls-container svelte-1mn61rz");
    			add_location(div, file$d, 86, 0, 1922);
    			attr_dev(th0, "class", "sort");
    			attr_dev(th0, "data-sort", "text");
    			add_location(th0, file$d, 93, 12, 2300);
    			attr_dev(th1, "class", "sort");
    			attr_dev(th1, "data-sort", "isPublished");
    			add_location(th1, file$d, 94, 12, 2357);
    			attr_dev(th2, "class", "sort");
    			attr_dev(th2, "data-sort", "detail");
    			add_location(th2, file$d, 95, 12, 2428);
    			add_location(th3, file$d, 96, 12, 2489);
    			add_location(th4, file$d, 97, 12, 2518);
    			add_location(tr, file$d, 92, 8, 2282);
    			add_location(thead, file$d, 91, 4, 2265);
    			attr_dev(tbody, "class", "list");
    			add_location(tbody, file$d, 100, 4, 2568);
    			add_location(table, file$d, 90, 0, 2251);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(input, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(86:0) <Table  options={settings}>",
    		ctx
    	});
    ...
    // (126:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleCreate}>
    function create_default_slot_8$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(126:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleCreate}>",
    		ctx
    	});
    ...
    // (127:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_7$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(127:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (120:0) <Modal bind:visible={modal.create} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot_6$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$d, 120, 4, 3335);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$d, 124, 4, 3904);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(120:0) <Modal bind:visible={modal.create} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
    ...
    // (137:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleUpdate}>
    function create_default_slot_5$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(137:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleUpdate}>",
    		ctx
    	});
    ...
    // (138:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_4$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(138:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (131:0) <Modal bind:visible={modal.update} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$d, 131, 4, 4373);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$d, 135, 4, 4951);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(131:0) <Modal bind:visible={modal.update} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
    ...
    // (145:8) <Button width="100%" backgroundColor="var(--theme-primary)" style="margin-right:2em;" on:click={handleDelete}>
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(145:8) <Button width=\\\"100%\\\" backgroundColor=\\\"var(--theme-primary)\\\" style=\\\"margin-right:2em;\\\" on:click={handleDelete}>",
    		ctx
    	});
    ...
    // (146:8) <Button width="100%" outline on:click={()=>{ modal.hide() }}>
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(146:8) <Button width=\\\"100%\\\" outline on:click={()=>{ modal.hide() }}>",
    		ctx
    	});
    ...
    // (142:0) <Modal bind:visible={modal.delete} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(button1.$$.fragment);
    			attr_dev(h3, "class", "svelte-1mn61rz");
    			add_location(h3, file$d, 142, 4, 5420);
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			set_style(div, "justify-content", "space-around");
    			add_location(div, file$d, 143, 4, 5445);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(142:0) <Modal bind:visible={modal.delete} style=\\\"display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em\\\">",
    		ctx
    	});
    ...
    const self$1 = async (data, config)=>{
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$f, 58, 2, 1329);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$i, create_fragment$i, safe_not_equal, { env: 1 });
