...
<table >
    <thead>
        <tr>
            ...
            <th class="sort" data-sort="oAuthId">OAuthId</th>
            <th class="sort" data-sort="oAuthData">OAuthData</th>
            <th>Update</th>
            <th>Delete</th>
        </tr>
    </thead>
...
<Modal bind:visible={modal.create} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    ...
    <Input placeholder="OAuthId" backgroundColor="var(--theme-light-gray)" foregroundColor="var(--theme-dark-gray)" style="margin-right:2em;" bind:value={newUser.oAuthId }/>
    <Input placeholder="OAuthData" backgroundColor="var(--theme-light-gray)" foregroundColor="var(--theme-dark-gray)" style="margin-right:2em;" bind:value={newUser.oAuthData }/>
...
<Modal bind:visible={modal.update} style="display:flex;flex-direction:column;width:40vw;min-width:280px;border-radius:0.5em;padding:4em">
    ...
    <Input placeholder="OAuthId" backgroundColor="var(--theme-light-gray)" foregroundColor="var(--theme-dark-gray)" style="margin-right:2em;" bind:value={selectedUser.oAuthId }/>
    <Input placeholder="OAuthData" backgroundColor="var(--theme-light-gray)" foregroundColor="var(--theme-dark-gray)" style="margin-right:2em;" bind:value={selectedUser.oAuthData }/>
    <div style="display:flex;flex-direction:row;justify-content:space-around;">
